...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',#Lo mas arriba posible
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware', #Debe ir aqui
    'django.contrib.sessions.middleware.SessionMiddleware',
    'corsheaders.middleware.CorsMiddleware',#Debe ir arriba de common middleware
...
REST_FRAMEWORK = {
    #La api usara JWT para autenticar usuarios
    ...
    #Permite ver y probar la api en el navegador
    'DEFAULT_SCHEMA_CLASS': 'drf_spectacular.openapi.AutoSchema',
    #Controlamos el trafico de datos
...
#Cambiamos el almacenamiento por defecto de las imagenes
